...
source/fc_layer.o: /home/jamesliu/ECE1373/ECE1373_assignment1/fc_test/fc_layer.cpp
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C++ Compiler'
	g++ -DFC_DOTENG -I../dot_test/ -I/opt/Xilinx/Vivado_HLS/2017.2/lnx64/tools/auto_cc/include -I/opt/Xilinx/Vivado_HLS/2017.2/lnx64/tools/systemc/include -I/opt/Xilinx/Vivado_HLS/2017.2/include -I/home/jamesliu/ECE1373/ECE1373_assignment1/. -I/home/jamesliu/ECE1373/ECE1373_assignment1/vivado_hls_proj -I/opt/Xilinx/Vivado_HLS/2017.2/include/etc -I/opt/Xilinx/Vivado_HLS/2017.2/include/ap_sysc -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"source/fc_layer.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
